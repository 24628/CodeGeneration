...
public class OffsetPageableDate implements Pageable {
    private int limit;
    private int offset;
    ...
    public Pageable next() {
        ...
        return new OffsetPageableDate(getPageSize(), (int) (getOffset() + getPageSize()));
    }
    public Pageable previous() {
        // The integers are positive. Subtracting does not let them become bigger than integer.
        return hasPrevious() ?
                new OffsetPageableDate(getPageSize(), (int) (getOffset() - getPageSize())): this;
    }
    @Override
    ...
    public Pageable first() {
        return new OffsetPageableDate(getPageSize(), 0);
    }
    @Override
